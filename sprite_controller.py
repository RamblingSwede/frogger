...
class SpriteController:
    ...
    def update_display(self, screen, jump_dist, mov_x, mov_y):
        ...
        self.frog.update(self.screen_width, self.screen_height, self.block_size, jump_dist, mov_x, mov_y, True)
        self.frog.draw(screen)
        self.frog.update(self.screen_width, self.screen_height, self.block_size, jump_dist, mov_x, mov_y, False)
        self.frog.draw(screen)
